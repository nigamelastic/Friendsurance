...
public class Tests {
    ...
    public void S1TC1VerifyExpense(@Optional("jeher001") String username, @Optional("jeher") String password) {
    ...
    @Test(priority = 1)
    @Parameters({"username", "password"})
    public void S7TC1UserRegistration(@Optional("jeher001") String username, @Optional("jeher") String password) {
